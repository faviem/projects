...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "Aucun enregistrement n'existe dans la table !!!" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default Aucun enregistrement n'existe dans la table !!!
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "emptyTable": "Aucun enregistrement n'existe dans la table !!!"
			 *        }
			 *      } );
			 *    } );
			 */
			"sEmptyTable": "Aucun enregistrement n'existe dans la table !!!",
			 ...
			 *  @type string
			 *  @default Aucun enregistrement ne correspond a votre recherche
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sZeroRecords": "Aucun enregistrement ne correspond a votre recherche"
		},
