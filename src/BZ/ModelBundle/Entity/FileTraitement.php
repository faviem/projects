<?php
// src/BZ/ModelBundle/Entity/FileTraitement.php
...
/**
* BZ\ModelBundle\Entity\FileTraitement
*
* @ORM\Table(name="filetraitement")
* @ORM\Entity(repositoryClass="BZ\ModelBundle\Repository\FileTraitementRepository")
* @ORM\HasLifecycleCallbacks
*/
class FileTraitement
{
/**
    * @ORM\ManyToOne(targetEntity="BZ\ModelBundle\Entity\FileRequete", inversedBy="filetraitements")
...
//            $this->removeUpload();
    ...
    //            $this->setFile($file);
            ...
            // Et on génère l'attribut alt de la balise <Traitement>, à la valeur du nom du fichier sur le PC de l'internaute
        ...
        */
        ...
        {
        return 'uploads/Traitement/'.$this->getId().'.'.$this->getUrl();
        }
