...
/**
* BZ\ModelBundle\Entity\Departement
*
* @ORM\Table()
* @ORM\Entity(repositoryClass="BZ\ModelBundle\Repository\DepartementRepository")
...
class Departement
{
    ...
    */
     ...
     * @var string
     * 
     * @ORM\Column(name="nomdepartement", type="string", length=255, nullable=true)
     * 
     */
